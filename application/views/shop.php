<div id="page-content">
    ...
    <div class="collection-header">
        <div class="collection-hero">
            <div class="collection-hero__image"><img class="blur-up ls-is-cached lazyloaded" data-src="assets/images/cat-women.jpg" src="assets/images/cat-women.jpg" alt="Women" title="Women"></div>
                    ...
                    <div class="sidebar_widget filterBox filter-widget">
                        ...
                        <form action="#" method="post" class="price-filter">
                            <div id="slider-range" class="ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all">
                                ...
                                <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0" style="left: 46.8085%;"></span>
                            <div class="ui-slider-range ui-widget-header ui-corner-all" style="left: 0%; width: 46.8085%;"></div></div>
                            <div class="row">
                                <div class="col-6">
                        ...
                        <div class="row">
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 item" style="display: block;">
                                ...
                                <div class="product-image">
                                    ...
                                    <!-- countdown start -->
                                    <div class="saleTime desktop" data-countdown="2022/03/01"><span class="ht-count days"><span class="count-inner"><span class="time-count">0</span> <span>Days</span></span></span> <span class="ht-count hour"><span class="count-inner"><span class="time-count">0</span> <span>HR</span></span></span> <span class="ht-count minutes"><span class="count-inner"><span class="time-count">00</span> <span>Min</span></span></span> <span class="ht-count second"><span class="count-inner"><span class="time-count">00</span> <span>Sc</span></span></span></div>
                                    <!-- countdown end -->
                                ...
                                <!-- End product details -->
                                <!-- countdown start -->
                                <div class="timermobile"><div class="saleTime desktop" data-countdown="2022/03/01"><span class="ht-count days"><span class="count-inner"><span class="time-count">0</span> <span>Days</span></span></span> <span class="ht-count hour"><span class="count-inner"><span class="time-count">0</span> <span>HR</span></span></span> <span class="ht-count minutes"><span class="count-inner"><span class="time-count">00</span> <span>Min</span></span></span> <span class="ht-count second"><span class="count-inner"><span class="time-count">00</span> <span>Sc</span></span></span></div></div>
                                <!-- countdown end -->
                            </div>
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 item" style="display: block;">
                                <!-- start product image -->
                            ...
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 item" style="display: block;">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="#">
                                        <!-- image -->
                                        <img class="primary blur-up ls-is-cached lazyloaded" data-src="assets/images/product-images/product-image17.jpg" src="assets/images/product-images/product-image17.jpg" alt="image" title="product">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyloaded" data-src="assets/images/product-images/product-image17-1.jpg" src="assets/images/product-images/product-image17-1.jpg" alt="image" title="product">
                                        <!-- End hover image -->
                                        <!-- product label -->
                                        <div class="product-labels"><span class="lbl on-sale">Sale</span></div>
                                        <!-- End product label -->
                            ...
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 item" style="display: block;">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="#">
                                        <!-- image -->
                                        <img class="primary blur-up ls-is-cached lazyloaded" data-src="assets/images/product-images/product-image18.jpg" src="assets/images/product-images/product-image18.jpg" alt="image" title="product">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up ls-is-cached lazyloaded" data-src="assets/images/product-images/product-image18-1.jpg" src="assets/images/product-images/product-image18-1.jpg" alt="image" title="product">
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                            ...
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 item" style="display: block;">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="#">
                                        <!-- image -->
                                        <img class="primary blur-up ls-is-cached lazyloaded" data-src="assets/images/product-images/product-image19.jpg" src="assets/images/product-images/product-image19.jpg" alt="image" title="product">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyloaded" data-src="assets/images/product-images/product-image19-1.jpg" src="assets/images/product-images/product-image19-1.jpg" alt="image" title="product">
                                        <!-- End hover image -->
                                    </a>
                                    <!-- end product image -->
                            ...
                            <div class="col-6 col-sm-6 col-md-4 col-lg-3 item grid-view-item--sold-out" style="display: block;">
                                <!-- start product image -->
                                <div class="product-image">
                                    <!-- start product image -->
                                    <a href="#">
