...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo base_url(); ?>assets/dist/img/pwlogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a class="btn btn-sm btn-danger" href="<?php echo base_url(); ?>Login/logout">
          Logout
        </a>
      </li>
    </ul>
