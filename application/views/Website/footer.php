        ...
        <div class="site-footer">
        	<div class="container">
                ...
                <div class="footer-bottom">
                	<div class="row">
                    	<!--Footer Copyright-->
	                	<div class="col-12 col-sm-12 col-md-6 col-lg-6 order-1 order-md-0 order-lg-0 order-sm-1 copyright text-sm-center text-md-left text-lg-left"><span></span> <a href="https://www.kodplex.com">Powered By KodPlex.Pvt.Ltd</a></div>
